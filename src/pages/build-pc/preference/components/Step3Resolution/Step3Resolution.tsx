            ...
            {resolutions.map((d, index) => {
              ...
              return (
                <Fragment key={_.uniqueId()}>
                  ...
                  <figure
                    className={clsx(
                      'absolute left-0 top-0 with-ease min-w-full w-auto ',
                      { "z-10 md:h-[calc(100%_-_83px)] h-[calc(100%_-_50px)]": selectedRESIndex === d.title },
                      { "-z-10 h-0": selectedRESIndex !== d.title }
                    )}
                  >
                    <img src={selectedRESImage || ''} className="w-full h-full object-cover" alt="figure" />
                  </figure>
                  {/* )} */}
                </Fragment>
              )
